...
async def send_byte(dut, byte, serial_clock_period):
    ...
    await ClockCycles(dut.uio_in[3], serial_clock_period)
    await ClockCycles(dut.uio_in[3], serial_clock_period // 4)
    ...
    await ClockCycles(dut.uio_in[3], serial_clock_period // 4)
    await ClockCycles(dut.uio_in[3], serial_clock_period // 2)
